          ...
          <div class="form-group">   
            ...
            <div class="col-sm-4">
                ...
                %>
                    ...
                    <form action="GerarCertificado" target="_blank">
                    
                    <input class="form-control" type="hidden" name="cx_aluno" value="<%= aluno.getCodigo() %>" id="cx_aluno" size="4" maxlength="4" placeholder="0">    
                    <input class="form-control" type="hidden" name="cx_curso" value="<%= curso.getCodigo() %>" id="cx_curso" size="4" maxlength="4" placeholder="0">    
                        
                    <div class="form-group"> 
                        <input type="submit" value="Gerar Centificado" id="cert" name="cert" class="btn btn-success btn-lg btn-block">
                    </div>
