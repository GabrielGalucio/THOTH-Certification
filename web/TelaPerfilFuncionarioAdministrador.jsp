...
<html>
    <head>
        ...
        <title>Funcionário - ADMINISTRADOR</title>
    ...
    <body>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav">
                <li class=""><a href="TelaPerfilFuncionarioAdministrador">Home</a></li>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a onclick="location='http://localhost:8080/Thoth/RotaSessaoFuncionario.jsp?id=5'">Cadastrar Funcionário</a></li>
                  </ul>
                </li>
                
                 <!-- DROPDOW RESPONSÁVEL PELAS OPÇÕES DO PARECER -->
                <li class="dropdown">
                  <a class="dropdown-toggle" data-toggle="dropdown" href="#">Relatórios do Sistema<span class="caret"></span></a>
                  <ul class="dropdown-menu">
                    <li><a onclick="location='http://localhost:8080/Thoth/GerarRelLucro'">Relatório de Lucro</a></li>
                    <li><a onclick="">Rendimento</a></li>
                    <li><a onclick="">Outros</a></li>                    
                  </ul>
                </li>  
        ...
        <div class="form-group">
          <div class="col-sm-6">
            <h3>PROPOSTAS DE CURSO - FUNCIONARIO</h3>              
          </div>
          <div class="col-sm-6">          
        ...
        %>
          ...
          <table class="table table-striped table-bordered table-hover"> <!-- TABELA -->
            ...
            <tbody>
                ...
                for(Curso c: cursDao.listarCurso( "P" )){
