...
<html>
    ...
    <body>
        ...
        <div class="form-group">
          <div class="col-sm-6">
            <h3>CURSOS DO PROFESSOR - EM ANDAMENTO</h3>              
          </div>
          <div class="col-sm-6">          
        ...
        %>
          ...
          <table class="table table-striped table-bordered table-hover"> <!-- TABELA -->
            ...
            <tbody>
                ...
                for(Curso c: cursDao.listarCurso( professor.getCodigo(), "A" )){
                ...
                <tr> <!-- LINHA 1 DA TABELA -->
                    ...
                    <td>
                        <input type="button" value="Gerenciar" id="gerenciar" name="gerenciar" onclick="location='http://localhost:8080/Thoth/TelaMatriculasCurso.jsp?cd_curso=<%= c.getCodigo() %>'" class="btn btn-primary btn-group-justified">  </td>
                </tr>
