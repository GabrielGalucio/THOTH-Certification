...
<html>
    <head>
        ...
        <title>Configuração Conta - Funcionário</title>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-6"> <!-- COLUNA 1 DA PÁGINA -->
                 ...
                 <h2>Configuração Conta - Funcionário</h2> <!-- TÍTULO -->
                
                <form action="Funcionario_Alterar_Controle" method="post">
                    
                    <input class="form-control" type="hidden" name="cx_codigo_func" id="cx_codigo_func" value="<%= funcionario.getCodigo() %>" size="5" maxlength="5">
                    <div class="form-group"> <!-- agrupará e vai separar o label do campo e dos demais -->
                        <!-- campo código -->
                        <label for="cx_nome_funcionario">Nome:</label>                        
                        <input class="form-control" type="text" name="cx_nome_funcionario" id="cx_nome_funcionario" value="<%= funcionario.getNome() %>" size="100" maxlength="200" placeholder="Informe seu nome completo" autofocus required>
                    ...
                    <div class="form-group"> <!-- agrupará e vai separar o label do campo e dos demais -->
                        ...
                        <input class="form-control" type="email" name="cx_email_funcionario" id="cx_email_funcionario" value="<%= funcionario.getEmail() %>" size="50" maxlength="50" placeholder="Informe o seu endereço de email" required>
                    </div>
                   
                    <!-- abaixo mesma GRID --------------------------------------------------------------------->
                    <input class="form-control" type="hidden" name="lista_perfil" id="lista_perfil" value="<%= funcionario.getTipo() %>" size="4">
                                            
                    <div class="form-group"> <!-- agrupará e vai separar o label do campo e dos demais -->
                        <!-- campo nome -->
                        <label for="cx_senha_funcionario">Senha:</label>
                        <input class="form-control" type="password" name="cx_senha_funcionario" id="cx_senha_funcionario" size="50" value="" maxlength="50" placeholder="Informe sua senha de acesso" required>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group"> <!-- agrupará e vai separar o label do campo e dos demais -->
                            ...
                            <input class="form-control" type="number" name="cx_cpf" id="cx_cpf" size="11" maxlength="11" value="<%= funcionario.getCpf() %>" placeholder="00000000000">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group"> <!-- agrupará e vai separar o label do campo e dos demais -->
                            ...
                            <input class="form-control" type="tel" name="cx_telefone" id="cx_telefone" size="11" maxlength="11" value="<%= funcionario.getFone() %>" placeholder="00000000000">
                        </div>
                    </div>
                    <!-- ======================================================================================= -->
                    ...
                    <div class="form-group"> <!-- agrupará e vai separar o label do campo e dos demais -->
                        ...
                        <!-- campo voltar -->
                        <a type="reset" href="TelaPerfilFuncionario.jsp" class="btn btn-danger btn-lg">Voltar</a>
                    </div>
